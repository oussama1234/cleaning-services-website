/**
 * Booking confirmation email template with Tailwind CSS
 */
          ...
          <tr>
            <td class="text-center" style="padding: 48px 32px 32px; border-bottom: 2px solid rgba(255,255,255,0.2);">
              <div style="background: rgba(255,255,255,0.25); backdrop-filter: blur(10px); display: inline-block; padding: 16px 32px; border-radius: 16px; margin-bottom: 24px;">
                <img src="${appUrl}/images/cindel-nettoyage-logo.png" alt="Cindel Nettoyage" style="height: 60px; width: auto; display: block; margin: 0 auto;" />
              </div>
                ...
                <table role="presentation" style="width: 100%; border-collapse: separate; border-spacing: 12px 0;">
                  <tr>
                    <td style="width: 50%; padding: 20px 24px; background-color: #ede9fe; border-left: 4px solid #8b5cf6; border-radius: 8px;">
                      ...
                      <p class="text-purple-900 text-base font-bold" style="margin: 8px 0 0; color: #4c1d95; font-size: 17px; font-weight: 700;">${new Date(date).toLocaleDateString('fr-FR', { weekday: 'long', year: 'numeric', month: 'long', day: 'numeric' })}</p>
                    </td>
...
/**
 * Contact form email template with Tailwind CSS
 */
...
<body class="bg-gray-50 m-0 p-0" style="font-family: 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif;">
  ...
  <!-- Preheader text (hidden) -->
  <div style="display: none; max-height: 0; overflow: hidden; opacity: 0;">Nouveau message de ${name} - ${reasonLabels[reason] || 'Contact'}</div>
          ...
          <tr>
            <td class="bg-white" style="background-color: #ffffff; padding: 48px 32px;">
              ...
              <div style="margin-bottom: 36px;">
                ...
                <div class="rounded-lg" style="padding: 20px 24px; background-color: ${reasonBgColors[reason] || reasonBgColors.other}; border-left: 4px solid ${reasonColors[reason] || reasonColors.other}; border-radius: 8px;">
                  ...
                  <p class="text-lg font-bold" style="margin: 8px 0 0; color: #111827; font-size: 19px; font-weight: 700;">${reasonLabels[reason] || reason}</p>
                </div>
              </div>
